    ...
    <>
      ...
      <div className="space-y-6">
        <p>
          ...
          satellite cities of Jakarta. Currently I&apos;m a Software Engineering
          graduate from Universitas Pendidikan Indonesia. I started my study in
          2019 and graduated in 2023. But, i was an Industrial Engineering
          student in 2018 before i decided to move.
        </p>
        <p>
          I focus much of my time in collage to learn about software engineering
          & frontend web development using React & NextJS. I also regularly use
          cloud platform such as AWS, Azure & GCP and have experience in using
          Kubernetes & Red Hat Openshift. I love exploring stuff about
          technology.
        </p>
        <p>
          I&apos;m part of Red Hat&apos;s team as a Class Assistant & Help desk
          in{' '}
          <ExternalLink
            type="text"
          ...
          held by Yayasan Anak Bangsa Bisa & GoTo Group at Frontend Engineering
          Track.
        </p>
        <p>
          ...
          internship is with Sagara Technology, which is a software development
          house based in Jakarta & Bandung. After that, I&apos;m taking part as
          one of the interns at{' '}
          <ExternalLink
            type="text"
          ...
          Ministry of Education&apos;s Kampus Merdeka program. Which leads me to
          learn more about IT & tech in the banking industry, which is one of my
          interest outside of tech. At the start of 2023, after quite a long
          recruitment process, I finally get an offer from{' '}
          <ExternalLink
            type="text"
